...
with tab4:
    ...
    for m in mae_range:
        rv = calculate_rn_value(plant_mw, m, hub_stats, capture_rates) * BASE_DATA['annualization_factor']
        va = calculate_vt_alpha(virtual_mw, m, hub_stats, capture_rates) * BASE_DATA['annualization_factor']
        vh = calculate_vt_hedge(plant_mw, m, hub_stats, capture_rates) * BASE_DATA['annualization_factor']
    ...
    for c in cap_range:
        rv = calculate_rn_value(c, mae, hub_stats, capture_rates) * BASE_DATA['annualization_factor']
        va = calculate_vt_alpha(virtual_mw * c / plant_mw, mae, hub_stats, capture_rates) * BASE_DATA['annualization_factor']
        vh = calculate_vt_hedge(c, mae, hub_stats, capture_rates) * BASE_DATA['annualization_factor']
...
# ============================================
st.sidebar.markdown("---")
st.sidebar.markdown("*FG-GPT Value Creation Model v4.0*")
